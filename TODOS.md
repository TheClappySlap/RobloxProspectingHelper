...
## Phase 1 — Quick Fixes
- [] Mutation gear stats are not correct for granite, overclocked, and festive. Granite: 1.36×, +24 Dig Strength, +6 Shake Strength. Overclocked: 1.36×, +10% Dig Speed, +10% Shake Speed. Festive: 1.4×, +50 Luck, +10% Size Boost
